...
const meta = {
    title: "Terms of Use - KeyboardOS",
    dec: "At keyboardos.com, we take your privacy seriously. Our promise is simple: we make great tools, and we keep your personal info safe and sound",
    link: "https://keyboardos.com/terms-of-use"
}
...
export function generateMetadata() {
    ...
    return {
        ...
        keywords: 'Privacy Policy KeyboardOS',
        alternates: {
            canonical: meta.link,
        },
        openGraph: {
...
export default function TermsOfUse() {
    ...
    return (
        <div className="min-h-screen">
            ...
            <p>The KeyboardOS website located at https://keyboardos.com/ is a copyrighted work belonging to KeyboardOS. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
            ...
            <p>These Terms of Use described the legally binding terms and conditions that oversee your use of the Site. BY LOGGING INTO THE SITE, YOU ARE BEING COMPLIANT THAT THESE TERMS and you represent that you have the authority and capacity to enter into these Terms. YOU SHOULD BE AT LEAST 18 YEARS OF AGE TO ACCESS THE SITE. IF YOU DISAGREE WITH ALL OF THE PROVISION OF THESE TERMS, DO NOT LOG INTO AND/OR USE THE SITE.</p>
                ...
                <p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: Ali Park, Street Number 2, Sidhupura, Faisalabad. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
                ...
                <p>You can Contact us By visiting this page on our website: <Link href="/contact" className="a">https://keyboardos.com/contact</Link></p>
            </div>
                )
}